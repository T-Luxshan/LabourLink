  ...
  const handleLogin = async () => {
    try {
      ...
      try {
        ...
        if (role != userRole) throw new Error("Invalid email or password.");
        ...
        if (role == "CUSTOMER") {
          ...
          if (userRoleStatus) navigation.navigate("GettingStarted");
    ...
    <View style={styles.container}>
      <View style={styles.innerContainer}>
        <View>
          ...
          >
            Labour <Text style={{ color: "#F97300" }}>LINK</Text>
          </Text>
        </View>
        {/* App head sub tittle */}
        ...
        <View style={styles.toggleButtonContainer}>
          <View style={styles.innerToggleButtonContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.toggleButton,
                styles.cButton,
                role === "CUSTOMER" && styles.activeButton,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  styles.cButton,
                  role === "CUSTOMER" && styles.activeButtonText,
                ]}
              >
                Customer
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.toggleButton,
                styles.lButton,
                role === "LABOUR" && styles.activeButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.toggleButtonText,
                  role === "LABOUR" && styles.activeButtonText,
                ]}
              >
                Labour
              </Text>
          ...
          {errors.role && (
            <Text style={[styles.error, { marginLeft: 80, marginTop: 5 }]}>
              {errors.role}
            </Text>
          )}
        </View>
